...
class ImgController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      // Get the organized storage path
      $basePath = $this->getOrganizedStoragePath($request->imageable_type, $request->imageable_id);


      // Store the image - make sure it's using the 'public' disk
      $fullPath = $image->storeAs($basePath, $filename, 'public');
      ...
      $img = Img::create([
        ...
        'imageable_type' => $this->getFullClassName($request->imageable_type),
