...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 bg-white/10 backdrop-blur-md border border-white/10 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
