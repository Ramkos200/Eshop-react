																...
																@foreach ($orders as $order)
																		<tr class="hover:bg-gray-700/30 transition-colors duration-150">
																				<td class="px-6 py-4 whitespace-nowrap">
																						<div class="text-sm text-white">{{ $order->user->name ?? json_decode($order->Customer)->name }}
																						</div>
																						<div class="text-sm text-gray-300">
																								{{ $order->user->email ?? json_decode($order->Customer)->email }}</div>
																				</td>
																				<td class="px-6 py-4 whitespace-nowrap">
																				...
																				<td class="px-6 py-4">
																						<div class="text-sm text-gray-300">
																								<span class="text-white">{{ $order->items->count() }}</span> items
																						</div>
																				</td>
																				...
																				<td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
																						<div class="flex justify-end space-x-2">
																								<a href="{{ route('orders.edit', $order) }}"
																										class="text-blue-400 hover:text-blue-300 transition-colors" title="Edit Order">
