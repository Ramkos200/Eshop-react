                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-xl font-bold">QuickBuy</span>
                        </div>
                        <p className="text-gray-400 mb-4 leading-relaxed">
                            Your one-stop destination for quality products at
                            unbeatable prices. Shop with confidence and
                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <div className="text-gray-400 text-sm">
                            <p>&copy; 2025 QuickBuy. All rights reserved.</p>
                        </div>
                        ...
                        <div className="flex items-center space-x-2 text-sm text-gray-400">
                            ...
                            <div className="flex space-x-1">
                                <div className="w-6 h-4 bg-gray-700 rounded-sm flex items-center justify-center text-xs font-bold">
                                    V
                                </div>
                                <div className="w-6 h-4 bg-gray-700 rounded-sm flex items-center justify-center text-xs font-bold">
                                    MC
