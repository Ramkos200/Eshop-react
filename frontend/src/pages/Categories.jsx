  ...
  const renderCategoryCard = (category, level = 0) => {
    ...
    return (
      <div key={category.id} className={`${level > 0 ? "ml-4" : ""}`}>
        ...
        >
          <div
            className={`bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition duration-200 border border-gray-100 ${level === 0 ? "hover:border-blue-300" : ""
              }`}
          >
            <div className="h-75 bg-gray-100">
              {imageUrl ? (
                <img
                  src={imageUrl}
                  alt={category.name}
                  className="w-full h-full object-cover object-bottom group-hover:scale-105 transition duration-200"
                  onError={(e) => {
                    console.error(
            ...
            <div className="p-3">
              <h3
                className={`font-medium text-gray-900 group-hover:text-blue-600 transition ${level === 0 ? "text-base" : "text-sm"
                  }`}
              >
                {category.name}
              </h3>
